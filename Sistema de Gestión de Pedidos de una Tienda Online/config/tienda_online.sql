...
CREATE TABLE `pedido` (
  ...
  `estado` enum('pendiente','procesado','enviado','entregado') NOT NULL,
...
INSERT INTO `pedido` (`id`, `cliente`, `total`, `estado`, `fecha_creacion`) VALUES
(1, 'gabo', 102.00, 'pendiente', '2025-03-28 13:27:35');
